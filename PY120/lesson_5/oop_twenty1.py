    ...
    def deal(self, number_of_cards=2):
        ...
        for _ in range(number_of_cards):
            try:
                ...
                #self.deck = self.reset() # TODO TEST
...
class Player(Participant):
    ...
    def update_money(self, player_won):
        if player_won:
            ...
            print("\nYou earned another dollar!")
        else:
            self.betting_balance -= 1
            print("\nYou lost a dollar!")

    def display_money_available(self):
        print(f"You currently have ${self.betting_balance} for betting.")
...
class TwentyOneGame:
    ...
    def player_turn(self):
        ...
        while True:
            self.show_cards()
            print(f"\nYou currently have {self.player.current_score()} points")
    ...
    def dealer_turn(self):
        ...
        if not self.dealer.is_busted():
            self.dealer.stay() # TODO maybe unneccessary
    ...
    def display_result_update_money(self):
        ...
        print(f"{self.dealer.reveal_hand()} \n"
